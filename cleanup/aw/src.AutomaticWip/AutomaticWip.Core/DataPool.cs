...
{
    /// <summary>
    /// Maps flags/attributes for different types.
    /// </summary>
    public static partial class DataPool
    {
        /// <summary>
        /// Cached instance for internal usage only.
        /// </summary>
        static readonly IDataMapper INTERNAL_MAPPER = new EnumMapper();

        /// <summary>
        /// Cached instance for internal usage only.
        /// </summary>
        static readonly IDataMapper PUBLIC_MAPPER = new EnumMapper();

        /// <summary>
        /// #internal usage only.
        /// </summary>
        internal static IDataMapper Use(bool shared = false)
            => shared ? INTERNAL_MAPPER : new EnumMapper();

        /// <summary>
        /// Gets the cached mapper or creates a new one.
        /// </summary>
        public static IDataMapper GetMapper(bool shared = false)
            => shared ? PUBLIC_MAPPER : new EnumMapper();

        /// <summary>
        /// Cache the enum/fields/attributes to avoid using reflection on every call.
        /// </summary>
        internal sealed class EnumMapper : IDataMapper
        {
            /// <summary>
